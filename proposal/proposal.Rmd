...
## Detail
<!--
Small workshops will be dedicated to the generation of the user interface of the Shiny app and to map all the valuable options for prior beliefs in terms of data (e.g. nominal, ordinal, count, continuous) and input (expert panel, parameters, histgrams).
